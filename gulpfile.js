...
gulp.task('ftp-css', function() {
  return gulp.src('css/*')
    .pipe(ftp({
      ...
      user: 'chrisd',
      pass: 'G00berz',
      remotePath: '/Atlas/Sites/KenticoCMS 7.0.103/Energize/css'
    }));
});
...
gulp.task('ftp-scss', function() {
  return gulp.src('scss/*')
    .pipe(ftp({
      ...
      user: 'chrisd',
      pass: 'G00berz',
      remotePath: '/Atlas/Sites/KenticoCMS 7.0.103/Energize/scss'
    }));
});
...
gulp.task('ftp-scripts', function() {
  return gulp.src('js/*')
    .pipe(ftp({
      ...
      user: 'chrisd',
      pass: 'aachrisd',
      remotePath: '/Atlas/Sites/KenticoCMS 7.0.103/Energize/js'
    }));
});
